...
class Host(LogicMonitor):
    ...
    def add(self):
        ...
        if self.collector and not self.info:
            ...
            self.fail(msg='Specified collector does not exist')
        else:
    ...
    def sdt(self):
        ...
        if self.info:
            ...
            self.fail(msg='Error: Host does not exit.')
    ...
    def _verify_property(self, propname):
        ...
        if self.info:
            ...
            self.fail(
                msg='Error: Host does not exist. Unable to verify properties')
        ...
        if self.groups is not None:
            ...
            for group in self.groups:
                ...
                if groupjson is None:
                    ...
                    logging.debug('Group mismatch. ID does not exist.')
                    return True
                else:
